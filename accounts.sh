...
stellar keys generate borrower-1 --network testnet --fund
stellar keys generate borrower-2 --network testnet --fund
stellar keys generate borrower-3 --network testnet --fund
