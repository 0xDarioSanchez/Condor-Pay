...
const menuItems = [
  { title: "Dashboard", url: "/dashboard/empresa", icon: LayoutDashboard },
  { title: "Facturas", url: "/dashboard/empresa/facturas", icon: FileText },
  {
    title: "Confirmar Facturas",
    url: "/dashboard/empresa/confirmar",
    icon: CheckCircle2,
  },
  {
    title: "Pagar Facturas",
    url: "/dashboard/empresa/historial",
    icon: CreditCard,
  },
  { title: "Mi Empresa", url: "/dashboard/empresa/perfil", icon: Building2 },
  { title: "Ayuda", url: "/dashboard/empresa/ayuda", icon: HelpCircle },
];
      ...
      <nav className="flex-1 overflow-y-auto py-4 px-2 space-y-1">
        {menuItems.map((item) => (
          <NavLink
            key={item.url}
            to={item.url}
            end={item.url === "/dashboard/empresa"}
            className={cn(
