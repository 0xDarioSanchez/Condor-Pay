...
const menuItems = [
  { title: "Dashboard", url: "/dashboard/pyme", icon: LayoutDashboard },
  {
    title: "Subir Factura",
    url: "/dashboard/pyme/subir-factura",
    icon: FileUp,
  },
  { title: "Mis Facturas", url: "/dashboard/pyme/facturas", icon: FileText },
  { title: "Tracking", url: "/dashboard/pyme/tracking", icon: Clock },
  { title: "Off-Ramp", url: "/dashboard/pyme/off-ramp", icon: ArrowDownToLine },
  { title: "Mi Perfil", url: "/dashboard/pyme/perfil", icon: User },
  { title: "Ayuda", url: "/dashboard/pyme/ayuda", icon: HelpCircle },
];

export function PymeSidebar() {
